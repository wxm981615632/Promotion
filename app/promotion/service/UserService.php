...
class UserService extends CommonService {
	...
	public static function indexList($where,$field,$order,$limit,$page){
		try{
			$res = User::where($where)->field($field)->order($order)->paginate(['list_rows'=>$limit,'page'=>$page])->toArray();
		}catch(\Exception $e){
	...
	public static function add($data){
		try{
			validate(\app\promotion\validate\User::class)->scene('add')->check($data);
	...
	public static function update($data){
		try{
			validate(\app\promotion\validate\User::class)->scene('update')->check($data);
