...
//键值对增加选项
function appendToVal(pick){
	$('<div class="'+pick+'-line"><label class="form-inline" style="font-weight:normal;"><input type="text" class="form-control" placeholder="名称"></label> <label class="form-inline" style="font-weight:normal;"><input type="text" class="form-control" placeholder="值"></label> <label class="form-inline btn-group-sm"><button type="button" class="btn btn-danger cancel"><i class="fa fa-remove"></i></button> <button type="button" class="btn btn-info move"><i class="fa fa-arrows"></i></button></label></div>').appendTo($('.'+pick));
}
